"""Regression checks for the radian-net-proxy-pipe casebook."""
...
from casebook.harness import assert_expected, radian_net_proxy_pipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(radian_net_proxy_pipe_summary(), assert_expected())
